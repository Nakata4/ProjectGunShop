...
public class GunDetailsComponents extends JPanel implements ComponentListener
{
	...
	public GunDetailsComponents()
	{
        ...
        typeLabel.setFont(new Font(currentFont, Font.BOLD, 12));
        gridBagConstraints = new GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 3;
        gridBagConstraints.anchor = GridBagConstraints.WEST;
        gridBagConstraints.insets = currentInsets;
        compPanel.add(typeLabel, gridBagConstraints);
	...
	public void componentResized(ComponentEvent ev)
	{
		if (ev.getSource() == this)
		{
			...
			if (width >= 0)
			{
				...
				typeTextField.setColumns(width / divFactor);
	...
	public void displayDetails(Gun c)
	{
		...
		typeTextField.setText(c.getType());
